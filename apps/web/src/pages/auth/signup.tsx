...
export default function SignUp() {
  ...
  const [request] = useMutation(SignUpMutation);

  function handleRegister({ email, username, password }: User) {
    request({
      variables: {
        email,
        password,
          ...
          <Form onSubmit={handleRegister}>
            <div className="grid gap-y-4">
              <FormField name="email">
                ...
                <FormMessage match="valueMissing">Digite seu email</FormMessage>
              </FormField>
              ...
              <FormField name="username">
                ...
                <FormMessage match="valueMissing">Digite seu nome</FormMessage>
              </FormField>
